    ...
    render() {
        return (
            <div className="cakevr">
                <ProjectNav style={style.styleTitle} name="Cake VR" type="Dual-user VR Application " time="2020.02-2020.08" role="Independent Work" firm="The Dutch National Institution of Mathematics and Computer Science" img={img12} imgwidth="120%"/>
